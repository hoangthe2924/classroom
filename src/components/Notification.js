import { Button, Badge, Menu, MenuItem, Stack, Alert, AlertTitle, Snackbar } from '@mui/material';
  ...
  return (
    <>
      <Button
        ...
        onClick={handleClick}
      >
        {notifications.length === 0 ? (<NotificationsIcon sx={{ color: 'white' }} />) :
                  ...
                  <MenuItem key={notification.id} onClick={handleClose}>
                    ...
                    <AlertTitle>Giáo viên {notification.fromUser.fullname} đã thực hiện công bố điểm.</AlertTitle>
                      ...
                      <Stack
                        ...
                        spacing={2}
                      >
                        <strong>{notification.classNotification.className}</strong>
