...
import { Card, CardActions, Typography, Divider, Container, CardContent, FormControl, Button, InputLabel, FilledInput } from '@mui/material'
                                                        ...
                                                        >
                                                            <CardContent>
                                                                <FormControl variant="filled" sx={{ marginBottom: 3, width: '80%' }}>
                                                                    ...
                                                                    <FilledInput id="form-title" value={(onEditModeIndex === index) ?  tempData['name'] : name}
                                                                ...
                                                                <FormControl variant="filled" sx={{ marginBottom: 0, width: '80%' }}>
                                                                    ...
                                                                    <FilledInput id="form-detail" value={(onEditModeIndex === index) ? tempData['name'] : name} disabled={!(onEditModeIndex === index)} onChange={(e) => { handleEditGradeDetail(index, e.target.value) }} />
                                                                </FormControl>
                                                            </CardContent>
